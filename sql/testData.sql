...
INSERT INTO cyclist(id, age, name, time_total_hours, mountain_points, sprint_points, team_id) VALUES (6, 28, "Filippa", 7.4, 1, 1, 2);

INSERT INTO cyclist(id, age, name, time_total_hours, mountain_points, sprint_points, team_id) VALUES (7, 21, "Dolly", 4.8, 6, 3, 3);
INSERT INTO cyclist(id, age, name, time_total_hours, mountain_points, sprint_points, team_id) VALUES (8, 24, "Lovis", 3.5, 8, 5, 3);
INSERT INTO cyclist(id, age, name, time_total_hours, mountain_points, sprint_points, team_id) VALUES (9, 23, "Sanne", 9.2, 0, 0, 3);